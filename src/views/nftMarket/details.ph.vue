<template>
	<div class="my-assets-details-view relative">
		...
		<div class="scroll-auto">
			...
			<div class="module">
				<p class="title">Skill Details:</p>
			</div>
			<ul class="skill-s-list">
				<li v-for="(item) in skillSList" :key="item.id" class="skill-card" :class="[
		...
		<el-dialog :visible.sync="tradingDialog" width="90%" :show-close="false" :close-on-click-modal="false" :close-on-press-escape="false">
